              ...
              <b-modal id="one-signup-terms" size="lg" body-class="p-0" hide-footer hide-header>
                <div class="block block-rounded block-themed block-transparent mb-0">
                  ...
                  <div class="block-content">
                    <p>
                      This is a secure administration panel for CycoPay. Any prohibited use will be reported.
                    </p>
                  </div>
                  <div class="block-content block-content-full text-right border-top">
                    <b-button variant="alt-primary" class="mr-1" @click="$bvModal.hide('one-signup-terms')">OK</b-button>
                  </div>
                </div>
              </b-modal>
              <!-- END Terms Modal -->
