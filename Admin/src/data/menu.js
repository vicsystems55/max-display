...
export default {
  'main': [
...

    {
      ...
      to: '/backend/verifiedmerchants',
      icon: 'fas fa-user-check'
    },
    {
      name: 'Payment Links',
      to: '/backend/paymentlinks',
      icon: 'fas fa-link'
    },
    {
      name: 'Payments',
    ...
    {
      name: 'Email User',
      to: '/backend/emailuser',
      icon: 'fas fa-envelope'
    },

    {
      name: 'Requested Payouts',
      to: '/backend/requestedpayouts',
      icon: 'fas fa-hand-holding-usd'
    },
    {
      name: 'ID Documents',
      to: '/backend/iddocuments',
      icon: 'fas fa-id-card'
    },
    ...
    {
      name: 'Pages that need configuring',
      heading: true
    },
    {
      name: 'Dynamic Info Single Pages',
      icon: 'si si-energy',
      ...
      sub: [
        ...
        },
        {
          ...
          to: '/backend/paymentlinkinfo'
        },
        {
          name: 'Payment Info',
          to: '/backend/paymentinfo'
        },
        {
          name: 'Payout Info',
          to: '/backend/payoutinfo'
        },
        {
          name: 'Document Info',
          to: '/backend/documentsverify'
        }
      ]
    },
