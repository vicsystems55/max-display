          ...
          <b-dropdown size="sm" variant="dual" class="d-inline-block ml-2" menu-class="p-0 border-0 dropdown-menu-md" right no-caret ref="oneDropdownDefaultUser">
            ...
            <li @click="$refs.oneDropdownDefaultUser.hide(true)">
              <div class="p-3 text-center bg-primary-dark rounded-top">
                <p class="mt-2 mb-0 text-white font-w500">Admin</p>
              </div>
              <div class="p-2">
      ...
      notifications: [
        {
          ...
          title: 'You have approved a payout request',
          time: '15 min ago'
        },
        {
          href: 'javascript:void(0)',
        ...
        },
        {
          ...
          title: 'ID Documents for user[81029] were rejected by stripe: failed.',
          time: '26 min ago'
        },
        {
          href: 'javascript:void(0)',
        ...
        },
        {
          ...
          title: '2 Users registered last 24 hours.',
          time: '41 min ago'
        },
        {
          href: 'javascript:void(0)',
          icon: 'fa fa-fw fa-check-circle text-success',
          title: 'ID documents for user[12345] were approved by stripe.',
          time: '42 min ago'
        }
      ]
    }
