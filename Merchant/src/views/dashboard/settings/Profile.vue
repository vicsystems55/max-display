            ...
            <form action="#" @submit.prevent="">
              <div class="row g-3">
                <div class="col-xxl-12 col-12 mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="CycoPay* 818778" />
                </div>
             ...
             <a href="/notification" class="">Learn more<i class="ri-arrow-right-s-line"></i></a>
          </div>
        </div>
      </div>
      <div class="col-xxl-6 col-xl-6 col-lg-6">
                ...
                <div class="col-12 col-12 mb-3">
                  <button class="btn btn-primary">Save</button>
                   ...
                   <small class="mt-2 mb-0 d-block"
                    >You'll receive a notification on your email regarding this change.
                  </small>
              </div>
            </form>
          </div>
